...
from vllm.model_executor.parallel_utils.tensor_parallel.layers import VocabParallelEmbedding
        ...
        for name, loaded_weight in hf_model_weights_iterator(
            ...
            if name in state_dict:
                ...
                if "dense_h_to_4h" in name:
                    w_gate = loaded_weight[
                        mlp_hidden_shard_size * tp_rank:mlp_hidden_shard_size * (tp_rank + 1)
                    ]
