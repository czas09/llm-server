...
class SelfAttention(torch.nn.Module):
    ...
    def __init__(self, config, layer_number):
        ...
        self.rotary_emb = RotaryEmbedding(head_size=self.hidden_size_per_attention_head, rotary_dim=self.rotary_dim, max_position_embeddings=8192, base=10000, is_neox_style=True)
